...
<template>
  <div class="page">
    <header class="topbar">
      <img src="/logo-intuitive-care.jpg" alt="Logo Intuitive Care" class="logo" />
    </header>
    ...
    <main class="main">
      <div class="content">
        ...
        <p class="description">
          Digite o nome da operadora, CNPJ ou nome fantasia para buscar informações com base nos dados da ANS.
        </p>
